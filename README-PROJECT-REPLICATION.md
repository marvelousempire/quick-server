...
4. **Site schemas** (in `sites/*/schemas/`):
...
2. Check `core-functions-manifest.json` for function details
3. Customize `.env` for your project
4. Start building your site!

---

**See Also:**
- `README-MAIN-PROJECT-ENTRY.md` - Main project documentation
